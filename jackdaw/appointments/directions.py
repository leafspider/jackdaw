...
def directions_from_addresses(nads):
    ...
    body = {
        ...
        "destination": {
            "address": nads[-1][1]      # destination_address
        },
        "intermediates": [
        ...
        "polylineQuality": "OVERVIEW",
        # "routingPreference": "TRAFFIC_AWARE",
        "departureTime": "2025-10-23T15:00:00Z"     # TODO fix if necessary ?
    }

    # print("directions_from_addresses.body:", body)
    ...
    if response.status_code == 200:
        ...
        for leg, nad in zip( data['routes'][0]['legs'], nads[1:] ): 
